...
class Interceptor extends \Scandiweb\Popup\Model\ResourceModel\Popup\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAggregations');
        return $pluginInfo ? $this->___callPlugins('getAggregations', func_get_args(), $pluginInfo) : parent::getAggregations();
    }
